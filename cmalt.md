...
From December 2016 to January 2018, I was initially contracted at Plumpton College as the virtual learning environment developer. My role during this period was to develop their _Moodle_ platform branded [Plumpton Online](https://www.plumptononline.ac.uk) and train staff on the new system.
...
| --- | --- |
| 2018: | Level 3 Award in Education and Training, _City & Guilds_ |
...
When I first started working at Plumpton College, one of my first tasks was to work with staff to evaluated the learning technology that was currently being used in lessons or had the potential for use in the future. This was part of the college's wider Practial Blended Learning research project discussed below in [Specialist Options](/cmalt#specialistoptions). We identified the following ten technologies:
...
Description, Reflection, Evidence

### Understanding of Teaching, Learning and Assessment
![Teaching Tools](/images/teachingtools.png#poster "Teaching Tools")
...
Technology has become ubiquitous in the classroom and in the modern workplace, but how can further education colleges integrate technology and digital literacy effectively into their teaching programmes? In 2017, Plumpton College researched and evaluated new teaching practices as well as trialling the latest learning technologies in vocational subjects. The research was based on the use of ‘Blended Learning’. The term describes the ways that teaching programmes can mix traditional classroom learning techniques with digital technologies. The project has led to increased staff digital literacy and usage of technology within their teaching. Students have benefited from new and enhanced learning opportunities as well as development of their digital skills. The research was funded by a grant from the Education & Training Foundations Outstanding, Teaching, Learning & Assessment programme. It has been presented at JISC Digifest, Association of Colleges, Landex and the Blended Learning Consortium. Please download the [report](https://www.plumptononline.ac.uk/practical-blended-learning-report.pdf) and view the [presentation](https://www.plumptononline.ac.uk/practical-blended-learning-presentation.pdf) for more information.

### Teaching with Virtual Reality
Entry-level immersive technology has reached a price and complexity point where it is now accessible to the average classroom. But how can teachers effectively integrate these technologies into their lessons? In 2018, Plumpton College received research funding from the Education & Training Foundation to explore the use of virtual reality in the classroom. The college is leading a partnership of further education colleges – including Sussex Downs, Greater Brighton Metropolitan and Myerscough College – to produce a series of case studies of using different types of immersive technology in various teaching activities.
